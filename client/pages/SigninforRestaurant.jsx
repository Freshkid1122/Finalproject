...
import restaurant from "../src/assets/resturant.png";
import axios from "axios";
import { useNavigate } from "react-router-dom";

const SigninforRestaurant = () => {
  ...
  const handleSignin = async (e) => {
    ...
    const url = "https://finalproject-1-0ed5.onrender.com/signin/restaurant";
      ...
      >
        ...
        <div className="col-12 col-md-6 d-flex flex-column justify-content-center align-items-center p-4 p-md-5">
          <div style={{ width: "100%", maxWidth: "350px" }}>
            <h4 className="mb-4 fw-bold text-center">Sign In As A Restaurant</h4>
...
export default SigninforRestaurant;
